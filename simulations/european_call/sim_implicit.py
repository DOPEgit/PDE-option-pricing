"""
European Call Option - Implicit Finite Difference Method Simulation

Demonstrates the implicit FD method for European call pricing.
Shows unconditional stability and tridiagonal solver efficiency.
"""
...
print("="*70)
print("EUROPEAN CALL OPTION - IMPLICIT FINITE DIFFERENCE METHOD")
print("="*70)
print(f"\nParameters:")
...
print("Solving with Implicit FD method...")
...
plot_option_surface(
    ...
    pde.t_grid,
    pde.V,
    title="European Call Option (Implicit FD)",
    save_path="simulations/european_call/plots/call_surface_implicit.png"
)
...
plot_greeks_surface(
    ...
    delta_grid,
    gamma_grid,
    title_prefix="European Call (Implicit)",
    save_path="simulations/european_call/plots/call_greeks_implicit.png"
)
...
print("="*70)
print("\nGenerated plots:")
print("  - simulations/european_call/plots/call_surface_implicit.png")
print("  - simulations/european_call/plots/call_greeks_implicit.png")