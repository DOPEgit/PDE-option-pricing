"""
European Put Option - Implicit Finite Difference Method Simulation
"""
...
print("="*70)
print("EUROPEAN PUT OPTION - IMPLICIT FINITE DIFFERENCE METHOD")
print("="*70)
...
plot_option_surface(
    ...
    title="European Put Option (Implicit FD)",
    save_path="simulations/european_put/plots/put_surface_implicit.png"
)

plot_greeks_surface(
    pde.S_grid, pde.t_grid, delta_grid, gamma_grid,
    title_prefix="European Put (Implicit)",
    save_path="simulations/european_put/plots/put_greeks_implicit.png"
)
